      ...
      <Card className="w-full max-w-md rounded-3xl shadow-2xl border-0 overflow-hidden">
        ...
        <CardContent className="space-y-5 px-8 pb-8">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Button variant="outline" className="h-11 rounded-xl border-gray-200 hover:border-purple-300 hover:bg-purple-50 transition-all">
            ...
            <Button variant="outline" className="h-11 rounded-xl border-gray-200 hover:border-blue-300 hover:bg-blue-50 transition-all">
